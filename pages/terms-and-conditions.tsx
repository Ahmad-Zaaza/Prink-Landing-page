  ...
  return (
    <div style={{ paddingBlock: 24 }}>
      ...
      <MaxWidthWrapper>
        ...
        <Subtitle>
          Welcome to Prink – Short Fashion Videos (the &ldquo;App&ldquo;). These
          Terms and Conditions of Use (&ldquo;Terms&ldquo;) govern your use of
          the App, including any updates, new features, and services
        ...
        <OrderedList>
          <li>
            ...
            <Subtitle>
              ...
              &ldquo;us,&ldquo; or &ldquo;our&ldquo;). These Terms constitute a
          ...
          <li>
            ...
            <OrderedList>
              <li>
                By accessing or using the App, you accept and agree to be bound
                by these Terms.
              </li>
              <li>
          ...
          <li>
            ...
            <Subtitle>
              ...
              use of the Services after the changes have been posted constitutes
          ...
          <li>
            ...
            <Subtitle>
              We will communicate with you through the App, email, or any other
              means of communication we consider appropriate. You agree to
              receive communications from us electronically and that such
          ...
          <li>
            ...
            <Subtitle>
              ...
              features of your device, including but not limited to your camera
              and microphone.
            </Subtitle>
          </li>
          <li>
            ...
            <Subtitle>
              Additional Terms (Which are not mentioned shall be as per UAE law)
              In addition to these Terms, certain services or features of the
              App may have additional terms and conditions. If there is a
          ...
          <li>
            ...
            <Subtitle>
              To use the App, you may be required to create an account with us.
          ...
          <li>
            ...
            <OrderedList>
              <li>
                You may access and use the App for your personal, non-commercial
                use only.
              </li>
              <li>
          ...
          <li>
            ...
            <OrderedList>
              <li>
                ...
                owned by Prink or its licensors and are protected by
          ...
          <li>
            ...
            <OrderedList>
              <li>
                ...
                (&ldquo;UGC&ldquo;). By submitting UGC to the App, you grant us
                ...
                derivative works from your UGC in all media formats and channels
                now known or later developed without compensation to you.
              </li>
              <li>
                You represent and warrant that you have all necessary rights to
                grant us the license in 10.1 above and that your UGC does not
          ...
          <li>
            ...
            <OrderedList>
              <li>
                ...
                person or entity or falsely represent your affiliation with any
                person or entity; (iii) use the App for any commercial purpose
                or to advertise or promote any product or service; (iv) access
                or attempt to access the App or any part of it that you are not
                authorized to access; (v) interfere with the functioning of the
                App or the servers or networks connected to it or circumvent any
                technological measure we use to protect the App or its content.
              </li>
              <li>
                We reserve the right to suspend or terminate your access to the
                App if you violate any of these restrictions.
              </li>
              <li>
          ...
          <li>
            ...
            <OrderedList>
              <li>
                You are solely responsible for your UGC and for any consequences
                arising from your submission of UGC to the App.
              </li>
              <li>
              ...
              <li>
                We are not responsible for any UGC or third-party content on the
                App. We do not endorse, guarantee or assume any responsibility
                for the accuracy, completeness, timeliness or reliability of any
                UGC or third-party content.
              </li>
              <li>
          ...
          <li>
            ...
            <Subtitle>
              ...
              at any time and for any reason, without notice or liability. Users
              may also terminate their use of the App at any time. Upon
              termination, all licenses granted by the user will terminate, and
              the user must cease all use of the App.
            </Subtitle>
          </li>
          <li>
            <Subtitle boldVariant>Minimum age</Subtitle>
            <Subtitle>
              The offered Services are only for people 12 years of age and over.
              By using the Services, you confirm that you are over the relevant
              age specified above. If we learn that someone under the relevant
              age specified above is using the Services, we will terminate that
              user&apos;s account.
            </Subtitle>
          </li>
          <li>

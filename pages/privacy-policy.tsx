    ...
    <div>
      ...
      <div style={{ paddingBottom: 64 }}>
        <MaxWidthWrapper>
          ...
          <Subtitle>
            At Prink – Short Fashion Videos, we take your privacy very
            seriously. This privacy policy explains how we collect, use, share,
            and protect your personal information when you use our app (the
            &ldquo;App&ldquo;).
          </Subtitle>
          <OrderedList>
            <li>
              ...
              <UnOrderedList>
                <li>
                  Your personal information, such as your name, email address,
                  and telephone digits.
                </li>
                <li>
                  Your login and usage data, encompassing your IP address,
                  device classification, operating system, and the pages which
                  you visit
                </li>
                <li>Your location data, should you opt to share it with us</li>
                <li>
                  Information regarding your device, including its
                  identification code and software version.
                </li>
              </UnOrderedList>
            </li>
            <li>
              ...
              <UnOrderedList>
                ...
                <li>
                  Personalizing your experience, by suggesting content that
            ...
            <li>
              ...
              <UnOrderedList>
                <li>
                  ...
                  processors, and analytics companies, who assist us in
            ...
            <li>
              ...
              <Subtitle>
                ...
                to provide our services and comply with legal obligations. After
            ...
            <li>
              ...
              <Subtitle>
                ...
                needs of our users. Therefore, we may make changes to this
                Privacy Policy from time to time. We will notify you of any
                changes by updating the &quot;Last Updated&quot; date at the top
                of the policy and by providing you with a notice within the app.
              </Subtitle>
            </li>
            <li>
              <Subtitle boldVariant>
            ...
            <li>
              ...
              <Subtitle>
                various cookies and tracking technologies to analyze user
                behavior and to improve our services continually. These
                technologies will allow us to provide you with highly targeted
                and personalized content, thereby enhancing your experience with
                our app.
              </Subtitle>
            </li>
            <li>
            ...
            <li>
              ...
              <Subtitle>
                ...
                personalize your experience, communicate with you, and comply
            ...
            <li>
              ...
              <Subtitle>
                ...
                However, we may disclose your information to reliable
                third-party service providers that facilitate the provision of
                our application&apos;s services.
              </Subtitle>
            </li>
            <li>
              <Subtitle boldVariant>
            ...
            <li>
              ...
              <Subtitle>
                ...
                data, as well as to object to or restrict its processing. You
                can exercise these rights by contacting us at info@prink.live.
            ...
            <li>
              ...
              <Subtitle>
                We&apos;ll keep it only for as long as needed to meet the
                original reasons for collecting it, or as mandated by law.
              </Subtitle>
            </li>
            <li>
              ...
              <Subtitle>
                ...
                entitlement to file a complaint with the pertinent data
                protection authority.
              </Subtitle>
            </li>
          </OrderedList>
